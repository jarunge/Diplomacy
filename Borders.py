...
empty_empty_connections = [
    # Western
    ('Wales', 'Yorkshire'), 
    ('Burgundy', 'Gascony'), ('Burgundy', 'Ruhr'), ('Burgundy', 'Picardy'),
    # Midline
    ('Piedmont', 'Tyrolia'), ('Tyrolia', 'Bohemia'), ('Bohemia', 'Silesia'), 
    ('Silesia', 'Prussia'), ('Prussia', 'Livonia'), 
    # Eastern
    ('Armenia', 'Syria'), 
    ('Galicia', 'Ukraine'), ('Galicia', 'Bohemia'), ('Galicia', 'Silesia'),
    ('Tuscany', 'Piedmont') 
]
